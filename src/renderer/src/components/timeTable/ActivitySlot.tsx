...
export const ActivitySlot = styled(Box, {
  shouldForwardProp: (prop) => prop !== 'startTime' && prop !== 'endTime' && prop !== 'appColor',
})<{ startTime: Date; endTime: Date; appColor: string | null }>(
  ({ startTime, endTime, appColor }) => {
    ...
    return {
      ...
      width: '1rem',
      overflow: 'hidden',
      backgroundColor: appColor ? appColor : 'transparent',
      margin: 0,
      padding: 0,
      fontSize: '0.75rem',
      // borderRadius: '5px',
