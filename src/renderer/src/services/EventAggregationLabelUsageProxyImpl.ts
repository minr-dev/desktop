...
import { IEventAggregationLabelUsageProxy } from './IEventAggregationLabelUsageProxy';
import { EVENT_TYPE } from '@shared/data/EventEntry';
import { EventAggregationTime } from '@shared/data/EventAggregationTime';
import { IpcChannel } from '@shared/constants';

@injectable()
export class EventAggregationLabelUsageProxyImpl implements IEventAggregationLabelUsageProxy {
